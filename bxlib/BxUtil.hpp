...
public:
	...
	*/
	...
	\param cp949length : 변환할 CP949스트링 배열수량(NULL문자제외, -1은 길이 자동측정)
	\param utf16 : 받을 UTF16스트링
	\param utf16length : 받을 UTF16스트링 배열수량(NULL문자제외)
	\return 변환된 배열수량
	*/
	...
	\param utf16length : 변환할 UTF16스트링 배열수량(NULL문자제외, -1은 길이 자동측정)
	\param cp949 : 받을 CP949스트링
	\param cp949length : 받을 CP949스트링 배열수량(NULL문자제외)
	\return 변환된 배열수량
	*/
	...
	*/
	...
	\param utf8length : 변환할 UTF8스트링 배열수량(NULL문자제외, -1은 길이 자동측정)
	\param utf16 : 받을 UTF16스트링

...
public:
	BxSimulator() : NCWindowPos(point::zero()), NCClickPos(point::zero()), GUIFont(nullptr)
	{
		...
		{
			GUIFont = BxCore::Font::Open(BxString::Parse("<>:<A><FS><A>", BxARG(Web.GetCachePath(), "labtest/r00000000n.TTF-01-BONEC-000000.NanumGothicExtraBold.ttf")), 8);
			GUIFontMini = BxCore::Font::Open(BxString::Parse("<>:<A><FS><A>", BxARG(Web.GetCachePath(), "labtest/r00000000n.TTF-01-BONEC-000000.NanumGothicExtraBold.ttf")), 6);
		}
